...
import { Wallet, Info, InfoIcon } from "lucide-react";
            ...
            <div className="px-4 pb-4">
              ...
              <div className="flex flex-col gap-2 text-base">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="text-green-600 font-medium"> - ₹{(totalMrp - subTotal).toFixed(2)}</span>
                </div>
                {couponDiscount > 0 && <div className="flex justify-between text-green-600 font-medium">
