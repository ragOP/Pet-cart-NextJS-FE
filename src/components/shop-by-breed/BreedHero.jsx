  ...
  return (
    <div className="flex flex-col gap-4 sm:gap-6 px-[5%]">
      ...
      <div className="flex flex-col lg:flex-row gap-4 sm:gap-6">
        {/* Left Side - Image - 50vh */}
        <div className="w-full lg:w-2/5 h-[54vh] lg:h-[60vh]">
          <div className="bg-[#EBEBEB] rounded-xl p-3 sm:p-4 h-full">
            <div className="bg-[#c6c6c6] rounded-lg shadow-sm h-full" style={{
              border: '1px dashed #6A6868',
              boxShadow: '0px 5px 50px -9px #0000000D, 0px 0px 0px 0px #00000026'
            }}>
              <div className="relative h-full bg-opacity-15 rounded-lg">
                <CustomImage
        ...
        {/* Right Side - Description and Characteristics - 50vh */}
        <div className="w-full lg:w-3/5 h-auto lg:h-[60vh]">
          <div className="bg-[#FFEACD] rounded-xl p-3 sm:p-4 h-full ">
            <div className="bg-[#ffe3b9] flex flex-col justify-between rounded-lg px-3 sm:px-4 py-3 sm:py-5 shadow-sm h-full" style={{
              border: '2.74px dashed #F59A11'
            }}>
              {/* Description */}
              <div className="mb-6">
                <h4 
                  className='text-gray-800 text-[1rem] sm:text-[1.35rem] leading-relaxed'
              ...
              <div className="space-y-3 sm:space-y-4">
                      ...
                      <div className="flex flex-wrap gap-1 sm:gap-2">
                        {breed.characteristics.colors.map((color, index) => {
                          ...
                          return (
                            <span 
                              key={index}
                              className={`inline-flex items-center justify-center px-3 sm:px-6 py-1 sm:py-2 text-xs sm:text-sm font-medium shadow-sm ${styles.bg} ${styles.text}`}
                            >
                              {color}
                            </span>
                          );
                  ...
                  <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 sm:gap-0">
                    ...
                    <span className="text-sm sm:text-[1.05em] font-medium" style={{ color: '#004e6a' }}>
