// List of Indian states with value, label, and code
const stateList = [
  ...
  // Union Territories
  { value: "andaman and nicobar islands", label: "Andaman and Nicobar Islands", code: "AN" },
  { value: "chandigarh", label: "Chandigarh", code: "CH" },
  { value: "dadra and nagar haveli and daman and diu", label: "Dadra and Nagar Haveli and Daman and Diu", code: "DN" },
